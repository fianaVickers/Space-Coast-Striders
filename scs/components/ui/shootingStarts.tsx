...
export function ShootingStarsAndStarsBackgroundDemo({content}) {
  return (
    <div className="h-[30rem] rounded-md bg-neutral-900 flex flex-col items-center justify-center relative w-full">
      <h2 className="relative flex-col md:flex-row z-10 text-8xl md:text-5xl md:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white flex items-center gap-2 md:gap-8">
        <span>{content}</span>
      </h2>
